...
## Ya no tan despegadas de su antiguo contexto clónico (Primer capítulo, subcapítulo II)
...
¿Temti murió?
Solo quienes no tienen ni idea de lo que realmente está ocurriendo ahora mismo son capaces y lo suficientemente atrevidos como para afirmarlo, pero ese fue el mensaje que se difundió... lo que para algunos temtiteros fue lo que se quiso comunicar, para los de afuera es algo que se cae de maduro.
...
Pero hay un problema... para los simples mortales nada de eso parece accesible, la gran luz resulta inútil si no se posee de la clave que la desbloquee. Aunque no sea dañina ni ofensiva, las condiciones desoladoras del entorno hacen que no sea muy pertinente permanecer allí.
...
## Fuegos inestables en las aguas (Primer capítulo, subcapítulo VI)
...
## Faro sobrecalentado inflamable alumbrando el desasosiego (Primer capítulo, subcapítulo VII)
...
# La impredecible nueva ocupación del vacío (Segundo capítulo)
...
No es como que Temti vaya a transformarse en algo totalmente diferente a lo que supo ser, pero tampoco es que hayan solo dos posibilidades: la gloria total, o la miseria absoluta... también aunque poco sean consideradas, pueden haber grises.

## Captando semillas para la tierra baldía (Segundo capítulo, subcapítulo I)
...
## Las únicas señales del abandono que no es tal (Segundo capítulo, subcapítulo II)
...
Hades continúa estando desaparecido y no ha dado señales algunas, para fines destructivos o protectores, brillaba y brilla por su ausencia. A. es otro enorme misterio, con lo tanto que se ha desvirtuado el rumbo de su creación y sus alrededores, el *///...Pero antes de despedirme...///* no puede ser tomado tan literalmente, podría estar comandando todo esto con quién sabe qué fines como podría haber dejado a otro sujeto desconocido a cargo. Responder al panorama del contexto clónico no suena muy irracional pero tampoco tiene mucho sentido si se respetan las raíces preponderantes del sitio. 
...
## El supuesto blindaje del estado oculto (Segundo capítulo, subcapítulo V)
...
## Derrocando, ¿a quién? (Segundo capítulo, subcapítulo IX)
...
*///Matamos al admin///*... ...*///esto es un golpe de estado, bienvenidos a la nueva administración.///* las frases oficiales que resumían el sobresalto.
...
Aprovechando una vulnerabilidad en el *//Protocolo Hades//*, la agrupación de *//los guardianes//* aclaraba solo algunas dudas de los anones, y no todas las que ellos presentaban.
La gran novedad, mencionar que camino al poder acabaron con la vida del anterior administrador A.. La aparente razón de su muerte fue a causa del letal uso de fármacos, concretamente *//risperdal//*.
...
## El comienzo de lo desconocido mientras aún no llega (Segundo capítulo, subcapítulo XV)
...
Además del hecho que mancha la reputación del sitio frente a propios y extraños más que nada, la consecuencia evidente, y sorprendente, fue la prohibición del *//tem de pendejas//*, uno de los que generaba más interés tanto en los temtiteros como en los foráneos.
...
## La esperada moderna conectividad de la lentitud (Segundo capítulo, subcapítulo XVII)
...
Las fechas especulativas anteriormente puestas por los anones fueron descartándose una por una, mientras la ansiedad se enfriaba lentamente... el compromiso aún estaba pendiente.
...
Así, desde el último *//gran salto//* registrado en las épocas navideñas, vuelve a haber un gran paquete de cambios, que permite nominarlo como Tercer Gran Salto.
...
## El retorno a la lenta caída libre (Segundo capítulo, subcapítulo XVIII)
...
## La decadencia acompañando la tradición historiadora (Segundo capítulo, subcapítulo XIX)
...
Sin todos los cimientos que acompañaban y hacían de respaldo para la decadencia temtiana, y también sin el varias veces llamado *//basurero//*, quedan unos pocos anones que son conscientes de la inestabilidad atravesada, y abrumados por esta continúan buscando métodos efectivos para lograr llevar adelante un nuevo proceso de restauración.
...
## Las esencias más antiguas, ¿vivas, esqueletizadas...? (Tercer capítulo, subcapítulo XI)
...
Sobre esas cuestiones, otra de ellas es que la mencionada iniciativa también puso en conocimiento que ese no sería el único vinculo vigente hoy día en Temti con el nombre del infernal, ya que desde la llegada del Tercer Gran Salto también se reveló un esqueleto del cual todos se percataron, y es aquel que se aloja en los tems vacíos, instaurando en la mente del temtitero desde el enojo, la frase *///Tanto les cuesta dejar un comentario?///*, y la impresión de arrancarse el cráneo, la presión de participar de los mismos. Si bien este lleva mucho más tiempo siendo posible objeto de interpretaciones, nadie nunca destacó dicha conexión y por ende pasó desapercibido.
...
Y sin salirse del tema, el inicial antecedente de Temti con estas entidades esqueléticas nunca fue relacionado con Hades, ya que el primer esqueleto incluso es más antiguo que la primera aparición del vigoroso de los infiernos en el sitio. Esta presencia mencionada permaneció atormentando a todo temtitero indiscriminadamente durante la época pre-Purga, con la famosa frase *///A sos re trol///*, y aunque aún es rebuscadamente accesible y no presenta ningún cambio, ya no cumple la misma función.
...
La oportunidad de ingresar un código para poder *//Unirse a instancia//* estuvo visible en aquel momento. También, antes, la posibilidad de mostrar voluntad en *//Crear instancia//* estaba, y hasta día de hoy no se sabe cual fue la consecuencia directa de todas las veces que se pulsó ese botón, a la vez que se entiende que nadie logró ingresar a ninguna Instancia Premium.
...
## Cuando la explicación se impone sobre la incertidumbre (Tercer capítulo, subcapítulo XIV)
...
## Siguiendo los primeros pasos de una pequeña distopia (Tercer capítulo, subcapítulo XVII)
...
No obstante, por alguna razón esos supuestos *//errores críticos//* salieron a la vista explícitamente, no hay registros de que haya ocurrido antes en la historia temtiana, no de esa forma. Parece totalmente intencional.
...
Tras muy numerosas *//Desapariciones de comentarios//*, las revoluciones bajaron notablemente y la coyuntura está terminando volviendo a estabilizarse, para ser como no muchos días atrás.
...
## La alegría verde, ¿el contraste del deterioro? (Cuarto capítulo, subcapítulo II)
...
## Otra vez Temti se fue de paseo (Cuarto capítulo, subcapítulo III)
...
## Las caras de lo cierto, sobre lo incierto (Quinto capítulo, subcapítulo IV)
...
## Amarillentas... ¿disputas territoriales? (Quinto capítulo, subcapítulo V)
...
## El supuesto mito de la mayor fama, volviéndose real (Quinto capítulo, subcapítulo VI)
...
## La caída a la dura lucha terrenal (Quinto capítulo, subcapítulo VIII)

> 22 de mayo de 2021, 23 de mayo de 2021

Los temtiteros celebraron la *//conquista//*, estuvieron felices con ella y revindicaron lo que tanto ansiaron, el vencer en una de sus luchas. 
...
## Un paso más cerca, para descubrir lo lejos que se está (Quinto capítulo, subcapítulo X)
...
Y por último para notar, dentro del pequeño recoveco que oficia de *//sala de espera//*, también hay una melodía que ambienta el lugar, como para contrarrestar el silencio y dejar un sencillo mensaje que no aparenta significar mucho, sobre la sensación de extrañar.
...
Puntos intermedios al respecto o alguna notable inclinación hacia alguno de los dos extremos... todo se puede resumir, la pregunta que más intriga antes de saber que pueda venir después es si podrá el silencio llegar a romperse antes del día señalado.
...
## La ilusión de estar en la misma Orbita (Quinto capítulo, subcapítulo XIII)

> 1 de setiembre de 2021

Entrando en la recta final... nada salió de lo esperado.
...
Se supone que llegó el Día E, el día del Reingreso en orbita, pero la gran expectativa de la multitud no se ha cumplido, nadie esperaba fallar al *//Comenzar!//*.
...
La cuenta regresiva desde el minuto cero estaba programada para desaparecer y dar lugar al enlace que todos pensaron permitiría acceder o al menos acercarse a aquello que iba a protagonizar el Reingreso en orbita, y a la vista está que el *//pase//*... ¿no ha sido habilitado?
...
aunque pueda estar entre la gente sigue sin dar indicios de vida, y el *///¿Y?///* se sigue escuchando tanto en suelos temtianos como rozzados, más fuerte que la canción When Im Gone, lo cual no es nada desorbitado, todos se preguntan lo mismo.
...
Mucho tiempo después, un elemento de la no tan vieja conocida organización de Temti, conectado con toda esa ambiciosa conformación que contenía a la *//instancia temti//*, vuelve a aparecer, lo que inevitablemente trae aparejada la idea de que todo ese *//cuento//* no haya sido tal y que de verdad se esté acercando una innovadora y explorable reforma.
